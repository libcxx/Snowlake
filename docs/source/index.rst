.. Snowlake documentation master file, created by
   sphinx-quickstart on Mon Jun 18 23:21:14 2018.
...
* Provide a flexible declarative language that is able to define the static
  type inference rules of most programming languages.
* Facilitate language developers in defining, documenting and sharing the
  set of type inference rules of any particular language.
* Alleviate the burden on language developers from implementing type
